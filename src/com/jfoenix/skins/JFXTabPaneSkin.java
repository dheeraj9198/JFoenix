...
public class JFXTabPaneSkin extends BehaviorSkinBase<TabPane, TabPaneBehavior> {
        ...
        for (int i = 0, max = tabContentHolders.size(); i < max; i++) {
            ...
            if (tabContentHolder.tab == selectedTab) {
                ...
                if (index != i) {
                    ...
                    if (isSelectingTab)
                        new Timeline(new KeyFrame(Duration.millis(320), new KeyValue(tabsContainer.translateXProperty(), -contentWidth * index, Interpolator.EASE_BOTH))).play();
    ...
    protected class HeaderContainer extends StackPane {
        ...
        public HeaderContainer() {
            ...
            //TODO change width here
            selectedTabLine.setStrokeWidth(3);
    ...
    protected class TabHeaderContainer extends StackPane {
        ...
        public TabHeaderContainer(final Tab tab) {
            ...
            tabText.setFont(Font.font("", FontWeight.MEDIUM, 14));
            tabText.setPadding(new Insets(11, 25, 11, 25));
            ...
            else tabText.setTextFill(/*tempLabelColor.deriveColor(0, 0, 0.9, 1)*/unselectedFontColor);
